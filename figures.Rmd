...
* [20260822_ame.rda](https://github.com/ammulders/amatteroftime/results/cont_cohort/20260822_ame.rda): results of our main analyses with bootstrapped standard errors

* [20260822_c1-3.rda](https://github.com/ammulders/amatteroftime/results/robustness/bycohort/20260822_c1.rda): results of our models split out by cohort
...
load(file="./results/cont_cohort/20260822_ame.rda")
AMEs <- x
...
load(file = "./results/robustness/bycohort/20260822_c1.rda")
coh1 <- x
rm(x)

load(file = "./results/robustness/bycohort/20260822_c2.rda")
coh2 <- x
rm(x)

load(file = "./results/robustness/bycohort/20260822_c3.rda")
coh3 <- x
rm(x)
...
AMEs.df$t <- (AMEs.df$original / AMEs.df$se)
...
min(round(check_minmax$ymin, 3))
max(round(check_minmax$ymax, 3))
...
min(round(check_minmax2$ymin, 3))
max(round(check_minmax2$ymax, 3))
