---
title: "Mentoring for gender equality in early-career grant receipt: extracting first and last names"
...
outputview <- phd_metadf[,c(8,1,2,3,4,10,12,11,13)]
...
phd_metadf %>%
  select(id, firstname, np, lastname, lastname_full, diss_birthplace, uni, phd_year, supervisors) -> phdnames
